...
public class SetBoxyCommand implements CommandExecutor {

    private WincentPlugin plugin;

    public SetBoxyCommand(){
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        plugin.saveConfig();
        player.sendMessage(ChatUtil.color("&e&l[&5&lEventy&e&l] &6Ustawiono &a&lboxy &6&lna kordach: &e&l"
